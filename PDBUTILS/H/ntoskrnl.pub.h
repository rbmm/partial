...
struct SMKM_STORE<SM_TRAITS>
{
	...
	static long SmStPrioritizeRegionsStore(SMKM_STORE<SM_TRAITS> *,unsigned long);
	...
	static unsigned long SmStGetDataInUseKb(SMKM_STORE<SM_TRAITS> *);
...
struct SMKM_STORE_MGR<SM_TRAITS>
{
	...
	static void SmHighMemPriorityWatchdogDpc(_KDPC *,void *,void *,void *);
